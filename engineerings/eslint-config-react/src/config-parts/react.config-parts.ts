...
/**
 * @see {@link https://eslint.org/docs/latest/user-guide/configuring/language-options#specifying-parser-options}
 */
export const reactParserOptions = {
  ...typescriptParserOptions,
  ecmaFeatures: {
    ...typescriptParserOptions.ecmaFeatures,
    jsx: true
  }
}
export const reactPlugins = [...typescriptPlugins, 'react', 'react-hooks']

export const reactBaseRules = {
  /**
...
export const reactJSXRuntimeRules = {
  /**
   * @see {@link https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/jsx-uses-react.md}
   */
