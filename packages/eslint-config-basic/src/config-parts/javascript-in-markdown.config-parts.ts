import { javascriptRules } from './javascript.config-parts'

export const javascriptInMarkdownPlugins = ['markdown']
export const markdownProcessorOverride = {
  files: ['**/*.{md,mkdn,mdown,markdown}'],
  processor: 'markdown/markdown'
}
export const javascriptInMarkdownRules = {
  ...javascriptRules
}
/**
 * @see https://github.com/eslint/eslint-plugin-markdown
 */
export const javascriptInMarkdownOverride = {
