...
export const typescriptParserOptions = {
  ...
  project: [
    ...
    './packages/*/*/tsconfig.eslint.json',
    './packages/*/*/tsconfig.json',
    './utilities/*/tsconfig.eslint.json',
    './utilities/*/tsconfig.json',
    './utilities/*/*/tsconfig.eslint.json',
    './utilities/*/*/tsconfig.json',
    './features/*/tsconfig.eslint.json',
    './features/*/tsconfig.json',
    './features/*/*/tsconfig.eslint.json',
    './features/*/*/tsconfig.json',
    './applications/*/tsconfig.eslint.json',
    './applications/*/tsconfig.json',
    './applications/*/*/tsconfig.eslint.json',
    './applications/*/*/tsconfig.json',
    './engineerings/*/tsconfig.eslint.json',
    './engineerings/*/tsconfig.json',
    './engineerings/*/*/tsconfig.eslint.json',
    './engineerings/*/*/tsconfig.json',
    './elements/*/tsconfig.eslint.json',
